...
def return_image(frame):
    ...
    # Apply thresholding
    _, binary = cv2.threshold(gray, 250, 255, cv2.THRESH_BINARY)
    contours, _ = cv2.x(binary, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)        
...
video_path = 'C:/Users/SURYA/Desktop/Surya/code_raja_code/ComputerVisionProject_MohanSC/Previous_Work/video.mp4'
